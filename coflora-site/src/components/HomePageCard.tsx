...
function HomePageCard({ img, name, text }: HomePageCardProps) {
    return (
        <div className="flex flex-col gap-12 mx-auto px-4 pt-20 max-w-7xl">
            <div className="flex md:flex-row flex-col items-center shadow-lg rounded-xl overflow-hidden card-bg">
                <img
                    src={img}
                    alt={name}
