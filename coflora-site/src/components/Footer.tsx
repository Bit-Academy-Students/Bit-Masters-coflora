...
function Footer() {
    return (
        <footer className="flex items-center min-[425px]:w-full min-[320px]:flex-col flex-wrap min-[425px]:flex-row justify-evenly h-auto bg-amber-200">
            <Link to="/" className="w-[270px] min-[768px]:w-[280px] min-[425px]:w-[50vw] min-[435px]:w-[150px] aspect-video object-contain"><img src="https://coflora.org/wp-content/uploads/2022/08/coflora_original_black.png"></img></Link>
            ...
            <div className="flex min-[768px]:w-auto gap-5 text-left justify-start min-[320px]:w-[320px]">
